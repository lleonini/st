...
xdrawline(Line line, int x1, int y1, int x2)
{
	...
	/*
	 * Draw the line in two passes: all backgrounds first, then all
	 * foregrounds. Otherwise a glyph whose rendered width overflows
	 * its cell (fallback-font icons/symbols, common with Nerd Font
	 * style glyphs) gets its overflow clipped away the moment the
	 * next run's background gets painted over it.
	 */
